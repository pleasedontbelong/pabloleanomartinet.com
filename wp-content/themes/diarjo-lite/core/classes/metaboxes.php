<?php
	...
	class diarjolite_metaboxes {
		...
		public function __construct( $posttype, $fields = array() ) {
			...
			add_action( 'save_post', array( &$this, 'diarjolite_metaboxes_save' ) );
		}
				...
				switch ( $field['type'] ) { 
					...
					<p class="wip_inputbox">
						...
						<div class="input-right">
							...
							<input name="<?php echo $field['id']; ?>" id="<?php echo $field['id']; ?>" type="<?php echo $field['type']; ?>" value="<?php if ( diarjolite_postmeta( $field['id']) != "") { echo diarjolite_postmeta( $field['id']); } ?>" style="width:100%"/>
					...
					<p class="wip_inputbox">
						...
						<div class="input-right">
						<textarea name="<?php echo $field['id']; ?>" id="<?php echo $field['id']; ?>" type="<?php echo $field['type']; ?>" style="width:100%"><?php if ( diarjolite_postmeta( $field['id']) != "") { echo stripslashes(diarjolite_postmeta( $field['id'])); } ?></textarea>
						</div>
						<div class="clear"></div>
					</p>
		...
		public function diarjolite_metaboxes_save() {
